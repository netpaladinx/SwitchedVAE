...
from model_conv_switched_vae_v2 import ConvSwitchedVAE
...
parser.add_argument('--save_dir', type=str, default='conv_switched_vae_v2')
parser.add_argument('--output_dir', type=str, default='conv_switched_vae_v2')
